	...
	<div class="container">
		<div class="sixteen columns">
			...
			<div class="search-container">
				...
				<!-- Form -->
				<form method="post"
					action="<?php echo $this->webroot; ?>jobs/browse">
					<h2>Find job</h2>
					<input name="keywords" id="keywords" type="text" class="ico-01"
						placeholder="job title, keywords or company name" value="" /> <input
						type="text" class="ico-02" placeholder="city, province or region"
						value="" />
					<button type="submit">
